...
<html>
    ...
    <div class="col-sm-6 col-md-3">
      <div class="thumbnail">
        <img src="images/robe_soiree_rouge.jpg" title="Robe de soirée rouge tendance" />
        <div class="caption">
    ...
    <div class="col-sm-6 col-md-3">
      <div class="thumbnail">
        <img src="images/robe_soiree_blanche.jpg" title="Robe de soirée blanche étincelante" />
        <div class="caption">
    ...
    <div class="col-sm-6 col-md-3">
      <div class="thumbnail">
        <img src="images/robe_soiree_bleueFonce.jpg" title="Robe de soirée bleue séductrice" />
        <div class="caption">
  ...
  <div class="row">  
    <!--Robe 5-->
      <div class="col-sm-6 col-md-3">
        <div class="thumbnail">
          <img src="images/robe_soiree_bleueClaire.jpg" title="Robe de soirée bleue attirante" />
          <div class="caption">
