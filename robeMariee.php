...
<html>
    ...
    <ul class="breadcrumb">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="images/robe_mariee_1.jpg" title="Robe de cocktail rouge" />
            <div class="caption">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="images/robe_mariee_2.jpg" title="Robe de cocktail noire" />
            <div class="caption">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="images/robe_mariee_3.jpg" title="Robe de cocktail rose" />
            <div class="caption">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="images/robe_mariee_4.jpg" title="Robe de cocktail verte" />
            <div class="caption">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="images/robe_mariee_8.jpg" title="Robe de cocktail corail" />
            <div class="caption">
