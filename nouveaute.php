    ...
    <body>
        ...
        <table class="imgAccueil">
            <tr>
                ...
                <td>
                    <img class="imgNouveaute2" src="Contenu/images/robe_mariee_2.jpg" title="Robe de mariée n°RDM02" />
                </td>
            </tr>
            <tr>
                <td>
                    <img class="imgNouveaute3" src="Contenu/images/robe_mariee_3.jpg" title="Robe de mariée n°RDM03" />
                </td>
                <td>
